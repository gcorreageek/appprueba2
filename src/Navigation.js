...
import { TabRouter, TabNavigator, StackNavigator, createNavigator, createNavigationContainer, } from 'react-navigation';
...
import { BackHandler, Platform, Image, Text, StyleSheet, StatusBar, View, } from 'react-native';
import { Constants } from 'expo';
import { TabViewAnimated } from 'react-native-tab-view';
import { DrawerLayoutAndroid, BorderlessButton, RectButton, } from 'react-native-gesture-handler';
...
const DrawerComponent = Platform.OS === 'android' ? DrawerLayoutAndroid : DrawerLayout;
...
class DrawerScene extends React.PureComponent {
  ...
  render() {
    ...
    const ScreenComponent = DrawerRouter.getComponentForRouteName( route.routeName );
...
class DrawerView extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {//nose para que sirve
